...
# Glasgow airport box
AIRPORT_CODE = "GLA"
tl_y, tl_x = 55.88027367773343, -4.453843627294303
br_y, br_x = 55.863108209321815, -4.41778953294639
...
def look_at_runway():
    ...
    bounds = api.get_bounds({"tl_x": tl_x, "tl_y": tl_y, "br_x": br_x, "br_y": br_y})
